...
_EXCEPTION_STATUS_MAP: dict[type[Exception], tuple[int, str]] = {
    ...
    IntegrationClientNotFoundError: (404, "NOT_FOUND"),
    ...
    IntegrationClientFinalJobTypeError: (409, "FINAL_JOB_TYPE"),
    LiveResearchEvidenceNotAvailableError: (409, "EVIDENCE_NOT_AVAILABLE"),
